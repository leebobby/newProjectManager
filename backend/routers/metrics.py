...
# 这里按私有别名再导出，既有调用点与文档引用因此不变。
from routers._req_progress import (
    DOMAIN_PROGRESS_FIELDS as _DOMAIN_PROGRESS_FIELDS,
    PRODUCT_PROGRESS_FIELDS as _PRODUCT_PROGRESS_FIELDS,
    WEIGHT as _WEIGHT,
    completion_score as _completion_score,
    is_delayed as _is_delayed,
    is_done as _is_done,
    row_completion as _row_completion,
    split_changed as _split_changed,
)
